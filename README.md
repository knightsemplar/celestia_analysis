...
This will automatically set up and run a Celestia Light Node with a new wallet and default settings on the Blockspacerace network, it will also add metrics to allow analysis through Otel Telemetry. Be sure to save your passphrase for future reference (search my_celes_key). 
